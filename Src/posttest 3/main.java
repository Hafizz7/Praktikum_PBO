        ...
        while(true){
            if(anakee.isEmpty()){                                
                for(int c = 0; c < 7; c++){
                    ...
                    Penduduk_anak pendanak = new Penduduk_anak(name[c],jenis_kelaminn[c], lokasi[c], agamae[c], nike[c], umure[c], sekolah[c]);
                    anakee.add(pendanak);              
                }
                for(int c = 0; c < 3; c++){
                ...
                if(input_menu == 1){
                    ...
                    int input_menu2;
                    input_menu2 = Integer.parseInt(br.readLine());                    
                    if(input_menu2 == 1){
                        ...
                        Penduduk_anak pendanak = new Penduduk_anak(t_nama, t_kelamin, t_alamat, t_agama, t_nike, t_umur, t_sekolah);
                        anakee.add(pendanak);  
                    ...
                    if(anakee.size() == 0){
                        ...
                        if(pilihh == 1){
                            ...
                            for(int c = 0; c < lansiaee.size(); c++){
                                ...
                                System.out.println("Nama Sekolah: " + lansiaee.get(c).getPenyakit());
                                System.out.println("--------------------------------------------");
                            }
                        }                        
                    }
                    ...
                    if(hapus_pilih == 1){
                        ...
                        System.out.println("-------------------------------------------");
                        System.out.println("Yakin Ingin Hapus Data Tersebut!");
