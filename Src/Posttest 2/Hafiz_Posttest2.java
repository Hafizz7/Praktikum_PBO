package pkg2109106045_muh.hafiz_posttest2;
...
public static void main(String[] args) throws Exception {
        ...
        ArrayList Penduduk_anak = new ArrayList<>();
        ArrayList Penduduk_lansia = new ArrayList<>();
        ...
        while(true){
            if(nama_a.size() == 0){
                ...
                for(int c = 0; c < 7; c++){
                    ...
                    nama_a.add(t_create1.getNama());
                    jenis_kelamin_a.add(t_create1.getJenis_kelamin());                
                    alamat_a.add(t_create1.getAlamat());
                    agama_a.add(t_create1.getAgama());
                    umur_a.add(t_create1.getUmur());                
                    nik_a.add(t_create1.getNik());
...
//                create t_create1 = new create("Hafiz","Laki-laki", "Samarinda", "Islam", 010202030202, 20);                
                ...
                if(input_menu == 1){                
                    ...
                    nama_a.add(t_create.getNama());
                    jenis_kelamin_a.add(t_create.getJenis_kelamin());                
                    alamat_a.add(t_create.getAlamat());
                    agama_a.add(t_create.getAgama());
                    umur_a.add(t_create.getUmur());                
                    nik_a.add(t_create.getNik());
