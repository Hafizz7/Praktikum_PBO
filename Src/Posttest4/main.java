        ...
        while(true){
            if(anakee.isEmpty()){                                
                for(int c = 0; c < 7; c++){
                    ...
                    Penduduk_anak pendanak = new Penduduk_anak(name[c],jenis_kelaminn[c], lokasi[c], agamae[c], nike[c], umure[c], sekolah[c], tinggi[c]);
                    anakee.add(pendanak);              
                }
                for(int c = 0; c < 3; c++){
                ...
                if(input_menu == 1){
                    ...
                    if(input_menu2 == 1){
                        ...
                        Penduduk_anak pendanak = new Penduduk_anak(t_nama, t_kelamin, t_alamat, t_agama, t_nike, t_umur, t_sekolah, t_tinggi);
                        anakee.add(pendanak);  
