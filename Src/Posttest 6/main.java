...
public class main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        login_interface cobalogin = new akun();
        login_interface adakah = new admin();
        cobalogin.input_akun();
//        adakah.buat_akun();        
//        System.out.println("Silah Pilih Menu Login");
//        System.out.println("1. Admin");
//        System.out.println("2. User");
//        int pilihLogin = Integer.parseInt(br.readLine());
//        if (pilihLogin == 1){
//            
//        }
        ...
        while(true){
            if(anakee.isEmpty()){                                
                ...
                for(int c = 0; c < 3; c++){
                    ...
                    int[] umure = {82,80,101};          
                    int[] lama_sakitt = {2,3,4};
                    Penduduk_lansia pendaklansia = new Penduduk_lansia(name[c],jenis_kelaminn[c], lokasi[c], agamae[c], nike[c], umure[c], penyakit[c], lama_sakitt[c]);                    
                ...
                if(input_menu == 1){
                    ...
                    if(input_menu2 == 1){
                        ...
                        System.out.print("Lama Penyakit: ");
                        int t_lama_sakit = Integer.parseInt(br.readLine());
                        Penduduk_lansia pendalansia = new Penduduk_lansia(t_nama, t_kelamin, t_alamat, t_agama, t_nike, t_umur, t_penyakit, t_lama_sakit);                        
...
//                                System.out.println(anakee.get(b).toString());
                        ...
                        for (int c = 0; c < lansiaee.size(); c++) {
                            ...
                            //penggunaan static
                            Penduduk_lansia.printPenyakit(lansiaee.get(c));                            
                            System.out.println("--------------------------------------------");
                            }
                        }
                    ...
                    if(pilih_update == 1){
                     ...
                     System.out.println("Input Index yang Ingin di Ganti: ");
                        ...
                        System.out.print("Lama Penyakit: ");
                        int lama_sakit = Integer.parseInt(br.readLine());
                        ...
                        lansiaee.get(ganti).setLama_penyakit(lama_sakit);
